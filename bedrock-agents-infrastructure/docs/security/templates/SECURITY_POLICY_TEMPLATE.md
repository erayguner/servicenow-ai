...
### 1.1 Purpose
This policy establishes the minimum security and privacy requirements for all systems, data, and personnel within [Organization Name].
...
### 1.3 Exceptions
Exceptions to this policy require written approval from the Chief Security Officer and must be documented with:
...
- Examples: Credit card data (PCI), health records (HIPAA), personal information (GDPR)
