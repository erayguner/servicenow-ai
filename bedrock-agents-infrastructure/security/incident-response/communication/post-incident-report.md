...
**Incident Duration:** {START_DATE} to {END_DATE} ({DURATION_DAYS} days)
**Incident Commander:** {IC_NAME}
**Report Prepared By:** {PREPARED_BY}, {PREPARED_DATE}
...
|--------|--------|--------|--------|
| Detection to Containment | < 30 min | {ACTUAL} min | ✓ {STATUS} |
| Root Cause Analysis | < 8 hours | {ACTUAL} hrs | ✓ {STATUS} |
| Service Recovery | < 4 hours | {ACTUAL} hrs | ✓ {STATUS} |
...
Name: {NAME} | Date: {DATE} | Signature: _______
